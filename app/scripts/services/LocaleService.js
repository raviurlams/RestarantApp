/**
 * @ngdoc service
 * @name orderistaApp.LocaleService
 * @description
 * # LocaleService
 * Factory in the orderistaApp.
 */
angular.module('orderistaApp')
  .service('LocaleService', function ($translate, appConfiguration, $rootScope, tmhDynamicLocale) {
    'use strict';
    // VARS
    var localesObj = appConfiguration.locales;
